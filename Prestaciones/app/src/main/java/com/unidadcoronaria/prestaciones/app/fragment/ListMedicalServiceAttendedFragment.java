...
public class ListMedicalServiceAttendedFragment extends BaseFragment implements MedicalServiceAdapter.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(ListMedicalServiceAttendedFragment.this.getActivity(), "REFRESH", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mAdapter = new MedicalServiceAdapter(this, Arrays.asList(ms2,ms1));
