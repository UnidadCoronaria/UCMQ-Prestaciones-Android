...
public class MedicamentFilterAdapter extends ArrayAdapter<Medicament> {

    private Callback callback;

    public MedicamentFilterAdapter(Context context, int resource, List<Medicament> objects, MedicamentFilterAdapter.Callback callback) {
